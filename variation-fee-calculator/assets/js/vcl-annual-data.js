...
(function (root) {
  ...
  var COUNTRIES = [
    ...
    { cc: "CZ", hasAnnual: true, turnoverBased: false, note: "", tariffs: [
      ...
      { id: "cms", label: "CMS", role: "CMS", base: 21345, addStrength: 21345, ccy: "CZK" },
      { id: "national", label: "national", role: "national", base: 21345, addStrength: 21345, ccy: "CZK" },
    ] },
    ...
    { cc: "EU", hasAnnual: true, turnoverBased: false, note: "", tariffs: [
      { id: "reference_innovative_mas", label: "Reference/innovative MAs", role: null, base: 232400, addStrength: null, ccy: "EUR" },
      { id: "art_10_1_3_10c", label: "Art. 10(1)/(3) & 10c", role: null, base: 60300, addStrength: null, ccy: "EUR", isDefault: true },
      { id: "art_10_4_biosimilar", label: "Art. 10(4) Biosimilar", role: null, base: 118100, addStrength: null, ccy: "EUR" },
    ] },
    { cc: "ES", hasAnnual: true, turnoverBased: false, note: "Reference 8(3) in the first 10 years; Generics and Reference 8(3) after 10 years", tariffs: [
      { id: "reference_8_3_10_yrs", label: "Reference 8(3) <= 10 yrs", role: null, base: 1711.71, addStrength: 1711.71, ccy: "EUR" },
      { id: "generic_8_3_10_yrs", label: "Generic & 8(3) > 10 yrs", role: null, base: 855.85, addStrength: 855.85, ccy: "EUR", isDefault: true },
    ] },
    ...
    { cc: "IE", hasAnnual: true, turnoverBased: false, note: "w/o Annual Enforcement Fee", tariffs: [
      { id: "annual_fee_10_ma_s", label: "Annual Fee <= 10 MA's", role: null, base: 865, addStrength: 865, ccy: "EUR", isDefault: true },
      { id: "annual_fee_each_add_ma", label: "Annual Fee each add. MA", role: null, base: 1080, addStrength: 1080, ccy: "EUR" },
      { id: "annual_fee_for_dormant_ma_s", label: "Annual Fee for Dormant MA's", role: null, base: 463, addStrength: 463, ccy: "EUR" },
    ] },
    ...
    { cc: "IT", hasAnnual: true, turnoverBased: false, note: "Annual fee per valid six-digit AIC", tariffs: [
      { id: "all", label: "RMS/CMS/national", role: null, base: 1879, addStrength: null, ccy: "EUR" },
    ] },
    ...
    { cc: "SI", hasAnnual: true, turnoverBased: false, note: "The value of one point shall be EUR 5.8", tariffs: [
    ...
    { cc: "UK", hasAnnual: true, turnoverBased: false, note: "", tariffs: [
      { id: "pom_standard", label: "POM - standard", role: null, base: 2908, addStrength: 2908, ccy: "GBP", isDefault: true },
      { id: "pom_reduced", label: "POM - reduced", role: null, base: 1450, addStrength: 1450, ccy: "GBP" },
      { id: "new_api", label: "New API", role: null, base: 11627, addStrength: 11627, ccy: "GBP" },
    ] },
  ];
